    ...
    for (Check obs : es.getFailures(idx)) {
      ...
      if (obs instanceof ObjectCheck && ((ObjectCheck)obs).contract instanceof ObjectContract) {
        ...
        if (ex instanceof EqualsReflexive 
          ...
          //Log.log("Error statement in failure analyzer: " + st);
        }

      } else {
        
//        System.out.println("obs not object check: " + obs.getClass());
      ...
      //System.out.println("   stmt: " + st + ", vioCls: " + vioCls + ", failuer num: " + failures.size());
    }
  }
